    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Seleccionar e implementar los elementos de protección personal - EPP
        p.mb-4 Con el fin de reforzar algunos de los conceptos vistos en este componente, realice la siguiente actividad, completando las frases que a continuación se enuncian:
