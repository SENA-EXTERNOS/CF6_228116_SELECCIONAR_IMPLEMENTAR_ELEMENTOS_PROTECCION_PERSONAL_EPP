...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-3 A continuación, se enumera cada aspecto que debe tener en cuenta para los permisos de trabajo en alturas:
    ...
    p.my-4 Observe en el siguiente anexo un ejemplo del formato permiso de trabajo en alturas.
